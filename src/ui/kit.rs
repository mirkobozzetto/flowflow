pub const BTN_PRIMARY: &str = "pressable w-full min-h-[44px] flex items-center justify-center rounded-xl bg-ios-orange text-white text-sm font-medium hover:bg-ios-orange-dark disabled:opacity-45";
...
pub const CONFIRM_BTN_DANGER: &str = "pressable flex-1 h-9 flex items-center justify-center rounded-lg bg-ios-red text-white text-sm font-medium hover:opacity-90";

pub const PILL_PRIMARY: &str = "pressable shrink-0 h-9 px-3 flex items-center justify-center rounded-lg bg-ios-orange text-white text-xs font-medium hover:bg-ios-orange-dark disabled:opacity-45";

pub const PILL_GHOST: &str = "pressable shrink-0 h-9 px-3 flex items-center justify-center rounded-lg bg-stone-100 text-stone-900 text-xs font-medium hover:bg-stone-200 active:bg-stone-300 disabled:opacity-45";
