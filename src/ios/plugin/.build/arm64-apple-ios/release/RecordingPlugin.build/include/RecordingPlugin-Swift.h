...
#ifndef RECORDINGPLUGIN_SWIFT_H
#define RECORDINGPLUGIN_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RecordingPlugin",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_EXTERN void flowflow_end_live_activity(void) SWIFT_NOEXCEPT;

SWIFT_EXTERN void flowflow_start_live_activity(int64_t startedAtUnix, BOOL isPaused) SWIFT_NOEXCEPT;

SWIFT_EXTERN void flowflow_update_live_activity(int64_t startedAtUnix, BOOL isPaused) SWIFT_NOEXCEPT;
