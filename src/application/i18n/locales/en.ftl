...
connections-reinstall-agent = Reinstall agent
connections-reinstall-agent-done = Agent reinstalled from server
...
connections-agent-path = agent path (long-press to copy)
...
connections-test-run = Test run
connections-running = Running...
connections-bind = Bind
connections-sheet-url-placeholder = Paste a sheet URL
connections-sheet-url-hint = Or paste a sheet's URL to bind it directly.
connections-open-sheets = Open my sheets
