...
connections-reinstall-agent = Réinstaller l'agent
connections-reinstall-agent-done = Agent réinstallé depuis le serveur
...
connections-agent-path = chemin agent (appui long pour copier)
...
connections-test-run = Test
connections-running = En cours...
connections-bind = Lier
connections-sheet-url-placeholder = Colle l'URL d'une feuille
connections-sheet-url-hint = Ou colle l'URL d'une feuille pour la lier directement.
connections-open-sheets = Ouvrir mes feuilles
