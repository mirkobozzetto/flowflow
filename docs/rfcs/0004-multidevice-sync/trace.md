...
pass_scope: "T01-T05 (foundation) + T06/T08 (spikes) + T09-T13 (vecteurs: id déterministe + BLOB + fix store_chunks + backfill + reconstruct + boot reconcile)"
updated: "2026-06-09"
---
...
- Device-only restant (Mirko): ouvrir l'app, vérifier notes/RAG/suppression OK après cette passe (le backfill+reconcile tourne au boot sur la vraie base; additif, idempotent, flag une-fois, zéro-perte par ordre SQLite-d'abord).
