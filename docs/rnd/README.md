...
Research and development documentation for FlowFlow, a 100% Rust iOS app for voice + text notes with document import and RAG-powered chat.
...
Voice notes + text editing + document import + RAG/Chat.
No cosmetic features until intelligence layer is solid.
