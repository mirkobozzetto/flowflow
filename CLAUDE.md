...
This project is indexed by GitNexus as **flowflow** (1236 symbols, 2416 relationships, 103 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
