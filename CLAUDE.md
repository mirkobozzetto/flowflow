...
This project is indexed by GitNexus as **flowflow** (3226 symbols, 7350 relationships, 273 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
