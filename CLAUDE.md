...
This project is indexed by GitNexus as **flowflow** (1649 symbols, 2766 relationships, 108 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
