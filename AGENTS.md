...
This project is indexed by GitNexus as **flowflow** (1242 symbols, 2431 relationships, 104 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
