...
This project is indexed by GitNexus as **flowflow** (3719 symbols, 8257 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
