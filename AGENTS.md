...
This project is indexed by GitNexus as **flowflow** (4264 symbols, 10453 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
