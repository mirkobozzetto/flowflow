...
This project is indexed by GitNexus as **flowflow** (3718 symbols, 8255 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
